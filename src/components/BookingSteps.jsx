...
const BookingSteps = () => {
  const steps = [
    {
      icon: (
        <svg className="w-9 h-10 text-white bg-amber-400 rounded-xl" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      icon: (
        <svg className="w-9 h-10 text-white bg-red-500 rounded-xl " fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      icon: (
        <svg className="w-9 h-10 text-white bg-blue-900 rounded-xl" fill="none" viewBox="0 0 24 24" stroke="currentColor">
